---
title: "Estimating and Interpreting Effect Sizes: A Note for 432"
...
Consider the `small.csv` data available on our site, which is modeled on the public Framingham data set available [from BIOLINCC](https://biolincc.nhlbi.nih.gov/teaching/)[^1]. From the BIOLINCC documentation:
...
```{r, echo = FALSE, fig.height = 5, fig.width = 8, fig.fullwidth = TRUE}
plot(nomogram(m2))
```
