...
1. The [Class 08 Effects Note](https://github.com/THOMASELOVE/432-2021/tree/master/classes/class08) is now fixed. I fixed problems with the interpretations on old pages 9-, and I fixed the display of the nomograms. You want the version dated today.
    ...
    - Please use [the fixed version](https://github.com/THOMASELOVE/432-2021/blob/master/classes/class11/effects_note.pdf) in all work going forward, especially your Project 1 and Lab 3. I've attempted to delete the old version from our web site, but check the date to be sure.
